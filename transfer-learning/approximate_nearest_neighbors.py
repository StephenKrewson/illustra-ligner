"""
This file was written by Doug Duhaime as an early way to work with the Meserve-
Kunhardt 19C photo collection at Yale University Library. The Annoy library was
first written at Spotify to help with their recommendation engine. It provides
approximate nearest neighbor functionality for large datasets.
"""
...
# inputs are numpy vectors (1 x 2048)
